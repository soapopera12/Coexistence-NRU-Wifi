...
cellid=0
DETER_PERIOD = 16
MCOTTYPE=[8,8,8]                     # Time which a node is required to wait at the start of prioritization period in microseconds
OBSERVATION_SLOT_DURATION = 9         # observation slot length in microseconds
SYNCHRONIZATION_SLOT_A= 1000 #250
SYNCHRONIZATION_SLOT_B= 1000 #500
SYNCHRONIZATION_SLOT_C= 1000
SYNCHRONIZATION_SLOT= SYNCHRONIZATION_SLOT_A  # synchronization slot length in microseconds
SYNCHRONIZATION_SLOT_DURATION_FOR_RESERVATION = 400
SYNCHRONIZATION_SLOT_DURATION = [SYNCHRONIZATION_SLOT_A, SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C,SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C,SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C,SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C,SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C,SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C,SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C,SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C,SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C,SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C,SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C,SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C,SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C,SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C,SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C,SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C,SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C,SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C,SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C,SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C, SYNCHRONIZATION_SLOT_A,SYNCHRONIZATION_SLOT_B, SYNCHRONIZATION_SLOT_C] # synchronization slot length in microseconds
...
GAP_PERIOD = Gap.BEFORE        # insert backoff 'before', 'during', 'after', 'after_cca' backoff procedure.
...
DIFF_TXOP= True # normal mode or diff TXOP(MCOT) for diff numerology
...
class Gnb(object):
    def __init__(self, env, id, channel, desync, syncdur):
        self.env = env
    ...
    def sync_slot_counter(self):
        ...
        #print(desynchs.index(self.desync))
        global cellid 
        cellid = desynchs.index(self.desync)
        yield self.env.timeout(self.desync)  # randomly desync tx starting points
        #print(cellid)
        while True:
            self.next_sync_slot_boundary += self.syncdur
            yield self.env.timeout(self.syncdur)
    ...
    def sense_channel(self, slots_to_wait):
        ...
        try:
            ...
            pass  # if the procedure was interrupted by the start of a new transmission return remaining slots
    ...
    def wait_gap_period(self):
        ...
        while gap_length < 0:  # less than 0 means it's impossible to transmit in the next slot because backoff is too long
            gap_length += self.syncdur  # check if possible to transsmit in the slot after the next slot and repeat
    ...
    def run(self):
        ...
        while True:
            ...
            #print("has drawn a random backoff counter = {}".format(self.N))
            contention_failed = False  #for new rs 
            while True:
                yield self.env.process(self.wait_prioritization_period())
                self.log("prioritization period has finished")
                # ------- set RS_SIGNALS or gap here-------                     
                # writing algorithm here 
                # things to consider 
                # time_to_next_sync_slot, current cw, 
                time_to_next_sync_slot = self.next_sync_slot_boundary - self.env.now  # calculate time needed for gap
                if(time_to_next_sync_slot <= SYNCHRONIZATION_SLOT_DURATION_FOR_RESERVATION):      #self.next_sync_slot_boundary - self.env.now
                    RS_SIGNALS = True                  
                    GAP_PERIOD = False      #Gap.AFTER_WITH_CCA
                else:
                    RS_SIGNALS = False
                    GAP_PERIOD = Gap.AFTER_WITH_CCA
                # ------- set RS_SIGNALS or gap here------- 
            ...
            if self.syncdur==250:
                if (SKIP_NEXT_SLOT_BOUNDARY and self.skip == self.env.now) or (SKIP_NEXT_TXOP and self.skip):
                    self.skip = None
                    self.log("SKIPPING SLOT (will restart transmission procedure after {:.0f}us)".format(self.syncdur))
                    yield self.env.timeout(self.syncdur*3)
                    continue
            elif self.syncdur==500:
                if (SKIP_NEXT_SLOT_BOUNDARY and self.skip == self.env.now) or (SKIP_NEXT_TXOP and self.skip):
                    self.skip = None
                    self.log("SKIPPING SLOT (will restart transmission procedure after {:.0f}us)".format(self.syncdur))
                    yield self.env.timeout(self.syncdur)
            ...
            if DIFF_TXOP:
                if not (RS_SIGNALS or SKIP_NEXT_TXOP) :
                    if self.syncdur==250:
                    	MCOT=8
                    elif self.syncdur==500:
                    	MCOT=8
            ...
            if PARTIAL_ENDING_SUBFRAMES:
                ...
                trans_time = (MCOT * 1e3 - self.syncdur) + (self.syncdur/14) * last_slot
                #print(MCOT)
            else:
            ...
            if RS_SIGNALS:
                ...
                # ------ mechanism to send fragmented reservation signal ------   
                no_of_slots = int(time_to_next_sync_slot/20)                   # 20 us signal for sending the reservation signal
                rs_signal_slots = []                                           # list to hold the slots for sending reservation signal
                allowed_slots_to_send_rs = int((no_of_slots)/3)                   # Maximum allowed slots to send reservation signal   
                for i in range(allowed_slots_to_send_rs):                         # randomly select n=6 slots for reservation signal transmission 
                    rs_signal_slots.append(random.randint(0, no_of_slots))        # selecting a slot randomly and adding it to the rs_signal_slots list 
                rs_signal_slots = list(set(rs_signal_slots))                      # removing the duplicates from the list
                rs_signal_slots.sort()  
                allowed_slots_to_send_rs = len(rs_signal_slots)
                for i in range(allowed_slots_to_send_rs):
                    time_to_wait = rs_signal_slots[i] * 20                                      # calculate amount of time to wait
                    rs_signal_slots = [x - rs_signal_slots[i] - 1 for x in rs_signal_slots]     # time to wait for next slot after sending rs_signal                     
                    sensing_proc_rs = self.env.process(self.sense_channel(time_to_wait))        # start sensing 
                    self.channel.sensing_processes.append(sensing_proc_rs)                      
                    m = yield sensing_proc_rs   
                    self.channel.sensing_processes.remove(sensing_proc_rs)
                    if m != 0:
                        self.log("Channel BUSY - rs signal period failed.")
                        contention_failed = True
                        break                                                                   # falling out if sensed something during the gap mechanism
                    transmission_rs = Transmission(self.env.now, 0, 20)                            # start fragmented reservation 
                    yield self.env.process(self.channel.transmit(transmission_rs))   
                if(contention_failed):                                                          # falling out if sensed something during the gap mechanism
                    continue
                # ------ mechanism to send reservation signal ------       
            ...
            self.log("is now occupying the channel for the next {:.0f} us (RS={:.0f} us)".format(transmission.end -                 transmission.start, transmission.rs_time))
...
def run_simulation(sim_time, nr_of_gnbs, seed, desyncs=None):
    ...
    gnbs = [Gnb(env, i, channel, desyncs[i],SYNCHRONIZATION_SLOT_DURATION[i],) for i in range(nr_of_gnbs)]
...
def dump_csv(parameters, results, filename=None):
    filename = filename if filename else 'resultss.csv'
    write_header = True
...
def dump_csv1(parameters,  filename=None):
    filename = filename if filename else 'simulations.csv'
    write_header = True
    if os.path.isfile(filename):
        write_header = False
    with open(filename, mode='a') as csv_file:
        
        fieldnames = parameters.keys()
        writer = csv.DictWriter(csv_file, fieldnames=fieldnames)
        if write_header:
            writer.writeheader()
...
if __name__ == "__main__":          
    ...
    GNBS = [3,6,9,12,15,18]
    N = 5  
    for kk in range(len(GNBS)):
        NR_OF_GNBS=GNBS[kk]
        l=[0]*(NR_OF_GNBS//3)
        m=[0]*(NR_OF_GNBS//3)
        n=[0]*(NR_OF_GNBS//3)
        airtime=[0]*(NR_OF_GNBS*N)
        fairness=[0]*N
        fairnessmax=0
        fairnessmin=1
        collissionprob=[0]*N
        ...
        for i in range(N):
            ...
            for result in results:
                ...
                print(result['id'])
                if result['id'] % 3 ==0:
                    l[(result['id']//3)]=result['occ'] / processed['occ']
                    airtime[i*NR_OF_GNBS+result['id']]=result['occ'] / processed['occ']
                
                
                elif result['id'] % 3 ==1:
                    m[(result['id']//3)]=result['occ'] / processed['occ']
                else:
                    n[(result['id']//3)]=result['occ'] / processed['occ']
            ...
            fairness[i]+=processed['jfi']
            channeleff[i]+=processed['eff']
            collissionprob[i]+=processed['pc']
            if fairnessmax<processed['jfi']:
                fairnessmax=processed['jfi']
            if fairnessmin>processed['jfi']:
                fairnessmin=processed['jfi']
            if collissionprobmax<processed['pc']:
                collissionprobmax = processed['pc']
            if collissionprobmin>processed['pc']:
                collissionprobmin = processed['pc']
            if channeleffmax < processed['eff']:
                channeleffmax = processed['eff']
            if channeleffmin > processed['eff']:
                channeleffmin = processed['eff']
            parameters = {'sim_time': SIM_TIME ,
                      'seed': SEED,
                      'N_sta': NR_OF_GNBS,
                      'rs': RS_SIGNALS,
        ...
        print("NR_OF_GNBS: ",NR_OF_GNBS)
        #for index in range(NR_OF_GNBS):
            #print('avg % of airtime of {} : {:.2f}'.format(index, (l[index]/N)*100))
            #print('avg % of airtime of 1 : {:.2f}'.format((m/N)*100))
            #print('avg % of airtime of 2 : {:.2f}'.format((n/N)*100))
        fair=['{:.4f}'.format(elem) for elem in fairness]
        fairnes=[float(elem) for elem in fair]
        eff=['{:.4f}'.format(elem) for elem in channeleff]
        pc=['{:.4f}'.format(elem) for elem in collissionprob]
        fairav=sum(fairnes)/N
        effav=sum([float(elem) for elem in eff])/N
        pcav=sum([float(elem) for elem in pc])/N
        #print(airtime)
        print('avg fairness : {:.4f}'.format(fairav))
        print('fairness max : {:.4f}'.format(fairnessmax))
        print('fairness min : {:.4f}'.format(fairnessmin))
        print('avg channel efficiency is :{:.4f}'.format(effav))
        print('max channel efficiency is :{:.4f}'.format(channeleffmax))
        print('min channel efficiency is :{:.4f}'.format(channeleffmin))
        print('avg collission probability is :{:.4f}'.format(pcav))
        print('max collission probability is :{:.4f}'.format(collissionprobmax))
        print('min collission probability is :{:.4f}'.format(collissionprobmin))
        end_time = time.time()
